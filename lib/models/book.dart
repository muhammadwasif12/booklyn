...
class Book {
  ...
  var rawImageLinks = (volumeInfo['imageLinks'] as Map<String, dynamic>? ?? {})
      .map((key, value) => MapEntry(key, value.toString()));

  // Fix: Convert http → https for all image links
  var secureImageLinks = rawImageLinks.map((key, value) {
    if (value.startsWith("http://")) {
      return MapEntry(key, value.replaceFirst("http://", "https://"));
    }
  ...
  return Book(
    ...
    imageLinks: secureImageLinks, // 👈 secure links set here
